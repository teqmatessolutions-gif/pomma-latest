...
def get_guest_profile(
    guest_email: Annotated[Any, Query(description="Guest's email address")] = None,
    guest_mobile: Annotated[Any, Query(description="Guest's mobile number")] = None,
    guest_name: Annotated[Any, Query(description="Guest's name (case-insensitive search)")] = None,
...
def get_food_orders(
    from_date: Annotated[Any, Query(description="Start date for filtering (YYYY-MM-DD)")] = None,
    to_date: Annotated[Any, Query(description="End date for filtering (YYYY-MM-DD)")] = None,
    db: Annotated[Any, Depends(get_db)] = None,
    skip: int = 0,
    limit: int = 20
):
...
def get_user_history(
    user_id: int,
    from_date: Annotated[Any, Query()] = None,
    to_date: Annotated[Any, Query()] = None,
    db: Annotated[Any, Depends(get_db)] = None
):
    """
...
def get_service_charges(
    from_date: Annotated[Any, Query()] = None,
    to_date: Annotated[Any, Query()] = None,
    fromDate: Annotated[Any, Query()] = None,
    toDate: Annotated[Any, Query()] = None,
    db: Annotated[Any, Depends(get_db)] = None,
    skip: int = 0,
    limit: int = 20
):
