...
def get_attendance_for_employee(employee_id: int, db: Annotated[Any, Depends(get_db)] = None):
...
def get_monthly_report(employee_id: int, year: int, month: int, db: Annotated[Any, Depends(get_db)] = None):
